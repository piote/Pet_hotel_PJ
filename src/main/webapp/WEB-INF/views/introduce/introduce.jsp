    	...
    	<form name="frmIntroduce" method="post" action="${contextPath}" enctype="multipart/form-data">	
    		...
    		<table border="0" align="center">
    			...
    			<tr id="tr_btn_modify" align="center">
					<td colspan="3">
						<input type="button" class="button" value="수정완료" onClick="fn_modify_introduce(frmIntroduce)">
		        ...
		        <section class="outline">
		            ...
		            <div class="outline_img_wrap" id="img_mod1" disabled>
		                <img src="${contextPath}/resources/img/hotel.jpg" alt="호텔" height="600">
		                <input type="hidden" name="intro_image1" value="${introduce.intro_image1}">
		            </div>
				</section>
	        	<!-- outline 개요 끝 -->
	        	<!-- feed 사료 시작 -->
		        <section class="feed">
		            <div class="feed_img_wrap" id="img_mod2">
		                <img src="${contextPath}/resources/img/feed.jpg" alt="사료" width="500" height="450">
		                <input type="hidden" name="intro_image2" value="${introduce.intro_image2}">
		            </div>
		            <div class="txt_feed">
		                <div class="bar"></div>
		                <p class="sec_title">
	        ...
	        <section class="spray">
	            ...
	            <div class="spray_img_wrap" id="img_mod">
	                <img src="${contextPath}/resources/img/spray.jpg" alt="소독" height="600">
	                <input type="hidden" name="intro_image3" value="${introduce.intro_image3}">
	            </div>
	        </section>
	        <!-- spray 소독 끝 -->
	        <!-- cctv 시작 -->
	        <section class="cctv">
	            <div class="cctv_img_wrap" id="img_mod">
	                <img src="${contextPath}/resources/img/cctv.jpg" alt="CCTV" width="400">
	                <input type="hidden" name="intro_image4" value="${introduce.intro_image4}">
	            </div>
	            <div class="txt_cctv">
	                <div class="bar"></div>
	                <p class="sec_title"> 
	        ...
	        <section class="call">
	            ...
	            <div class="call_img_wrap" id="img_mod">
	                <img src="${contextPath}/resources/img/call.jpg" alt="연락" height="400">
	                <input type="hidden" name="intro_image5" value="${introduce.intro_image5}">
	            </div>
	        </section>
	        <!-- call 연락 끝 -->
	        <!-- walk 산책 시작 -->
	        <section class="walk">
	            <div class="walk_img_wrap" id="img_mod">
	                <img src="${contextPath}/resources/img/walk.jpg" alt="산책" width="400">
	                <input type="hidden" name="intro_image6" value="${introduce.intro_image6}">
	            </div>
	            <div class="txt_walk">
	                <div class="bar"></div>
	                <p class="sec_title"> 
